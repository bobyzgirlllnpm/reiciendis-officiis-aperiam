...
[![npm version](https://img.shields.io/npm/v/@bobyzgirlllnpm/reiciendis-officiis-aperiam)](https://img.shields.io/npm/v/@bobyzgirlllnpm/reiciendis-officiis-aperiam)
...
yarn add @bobyzgirlllnpm/reiciendis-officiis-aperiam

# or

pnpm add @bobyzgirlllnpm/reiciendis-officiis-aperiam
```

Import and use it:

```javascript
import { parseSchema } from '@bobyzgirlllnpm/reiciendis-officiis-aperiam';
